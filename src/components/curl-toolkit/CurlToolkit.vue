        ...
        <div class="flex items-center gap-3 min-w-0">
          ...
          <nav class="flex items-center gap-0.5 p-0.5 rounded-lg bg-black/[0.03] dark:bg-white/[0.05] overflow-x-auto">
            <button
              ...
              :class="selectedEnvId === null ? 'bg-black/[0.06] dark:bg-white/[0.08] text-primary shadow-sm' : 'text-tertiary hover:text-secondary'"
            ...
            <button
              ...
              :class="selectedEnvId === env.id ? 'bg-black/[0.06] dark:bg-white/[0.08] text-primary shadow-sm' : 'text-tertiary hover:text-secondary'"
          ...
          <div class="relative flex-shrink-0">
            ...
            <div v-if="showAddEnv" class="absolute top-full left-0 mt-1 z-50 w-[240px] p-3 rounded-xl bg-black/[0.06] dark:bg-white/[0.08] border border-black/[0.08] dark:border-white/[0.08] shadow-lg space-y-2">
