...
<template>
  <div class="sql-input-panel flex-1 flex overflow-hidden relative">
    ...
    <div class="absolute bottom-2 right-2 flex items-center gap-1">
      <button
        class="px-2 py-1 rounded-md text-[10px] bg-black/[0.04] dark:bg-black/40 backdrop-blur-sm border border-white/20 text-secondary hover:text-primary hover:bg-black/[0.06] transition-all"
        @click="emit('parse')"
      >
