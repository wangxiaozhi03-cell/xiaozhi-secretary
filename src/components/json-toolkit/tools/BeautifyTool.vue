  ...
  <div class="flex flex-col h-full">
    ...
    <div ref="editorWrapRef" class="flex-1 flex min-h-0" :style="{ background: currentTheme.bg }">
      ...
      <div class="flex-1 relative min-h-0 overflow-hidden">
        ...
        <!-- 右下角字号控制 -->
        <div class="absolute bottom-2 right-2 flex items-center gap-0.5 px-2 py-1 rounded-lg bg-black/[0.06] dark:bg-gray-800/80 backdrop-blur-sm shadow-sm border border-black/[0.06] dark:border-white/[0.08] z-10">
          <button
